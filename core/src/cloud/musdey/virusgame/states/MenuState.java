...
public class MenuState extends State {
    ...
    private void setupText(){
        ...
        parameter.size = cloud.musdey.virusgame.config.Config.TITLE_SIZE;
    ...
    private void setupButtonSkin(){
        ...
        textButtonStyle.over = skin.newDrawable("white", Color.valueOf(cloud.musdey.virusgame.config.Config.COLOR_BLUE_WORLD2));
...
//        preferenceBtn.setSize(col_width*6,row_height*1.5f);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.begin();
        sb.draw(background, 0,0, cloud.musdey.virusgame.config.Config.VISIBLE_HEIGHT*imageRatio, cloud.musdey.virusgame.config.Config.VISIBLE_HEIGHT);
        sb.end();
