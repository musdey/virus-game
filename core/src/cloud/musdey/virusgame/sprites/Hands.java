package cloud.musdey.virusgame.sprites;
...
public class Hands {
    ...
    public Hands(int x, int y){
        ...
        texture = new Texture("Hand_Turkis_2.png");
        playerAnimation = new Animation(new TextureRegion(texture),4,0.5f);
        bounds = new Rectangle(x+0.5f,y+0.35f,0.5f,0.5f);
    ...
    public void update(float dt){
        ...
        velocity.scl(1/dt);
        bounds.setPosition(position.x+0.5f,position.y+0.35f);
    }
